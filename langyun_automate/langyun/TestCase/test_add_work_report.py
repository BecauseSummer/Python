...
class add_work_report(CaseLogin):
    ...
    def test_add_work_Report(self):
        ...
        actions.move_to_element(element, 0, 0).perform()
        self.driver.switch_to.frame(3)
        self.driver.find_element(By.LINK_TEXT, "添加工作汇报 ").click()
        self.driver.switch_to.frame(0)
        time.sleep(3)
        self.driver.find_element(By.NAME, "title").click()
        self.driver.find_element(By.NAME, "title").send_keys("春季夏令营")
        element = self.driver.find_element(By.CSS_SELECTOR, ".btn-primary")
        actions = ActionChains(self.driver)
        actions.move_to_element(element).perform()
        self.driver.find_element(By.CSS_SELECTOR, ".btn-primary").click()
        ...
        self.driver.find_element(By.CSS_SELECTOR, ".btn-success > .Hui-iconfont").click()
        self.driver.find_element(By.CSS_SELECTOR, ".btn-success > .Hui-iconfont").click()
        self.driver.close()